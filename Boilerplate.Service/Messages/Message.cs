...
namespace Boilerplate.Service.Message
{
    public static class MessageType
    {
        ...
        {
            return new Messages { Status = false, Data = data, Message = "Error, can't update data!", MessageType = "Error" };
        }
        ...
        {
            return new Messages { Status = false, Data = data, Message = "No Data Found!", MessageType = "NoData" };
        }
